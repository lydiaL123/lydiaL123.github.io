...
Yunbo is a Ph.D. student in the Department of Engineering at the University of Cambridge, specializing in data generation in both latent and hyperbolic spaces. His research on tabular data focuses on representing heterogeneous column data in latent space using pre-trained language models and enabling flexible generation of relational data through diffusion-based models. Additionally, he explores conditional generation of heterogeneous data within a shared latent space. In the realm of graph data, Yunbo investigates data distillation in hyperbolic space to reduce redundancy in large-scale datasets and optimize them for specific machine learning tasks.
